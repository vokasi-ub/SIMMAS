      ...
      <div class="box box-danger">
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">List Data kk</h3>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modaal-header">
                ...
                <form class="form-horizontal" action="/inputdatakk/store" method="post">
                {{ csrf_field() }}
              <div class="box-body">
             ...
             @foreach($kk as $kk)
                 <tr>
                  ...
                  <td>{{$kk->nama_kk}}</td>
                   ...
                   <td>{{$kk->created_at}}</td>
                   <td>{{$kk->updated_at}}</td>
                     <td>  <a href="/kkedit/edit/{{ $kk->no_kk }}">Edit</a> 
                      | <a href="/hapus/deletekk/{{ $kk->no_kk }}" onClick="return confirm('Are you sure you want to delete?')">Hapus</a></td>
    </tr>
  @endforeach
            </table> 
            </div>
